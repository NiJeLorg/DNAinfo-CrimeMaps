...
class Command(BaseCommand):
	...
	def export_gerritsen_beach(self):
		...
		# Pull bay terrace
		NYCneighborhoods = neighborhoodNYC.objects.filter(dnaurl='gerritsen-beach')
	...
	def handle(self, *args, **options):
		print "Exporting Gerritsen Beach...."
		self.export_gerritsen_beach()
