...
// initialize map
function DNAinfoNYCFireworks2015citywide() {
	...
	this.map.on('zoomend', function(e) {
	    DNAinfoNYCFireworks2015citywide.checkZoomSwitchLayers();
	});
...
DNAinfoNYCFireworks2015citywide.slightPanUp = function (){
	var point = L.point(0, 150);
	MY_MAP.map.panBy(point);
}

DNAinfoNYCFireworks2015citywide.onEachFeature_FIREWORKS = function(feature,layer){	
	var highlight = {
	    weight: 2,
	    color: '#000'
	};
...
DNAinfoNYCFireworks2015citywide.onEachFeature_POLYGONS = function(feature,layer){	
	var highlight = {
	    color: '#000'
	};
	var noHighlight = {
...
DNAinfoNYCFireworks2015citywide.prototype.loadPointLayers = function (){
	// load points layers
	var thismap = this;
	...
	d3.json("https://data.cityofnewyork.us/resource/fhrw-4uyv.geojson?$$app_token=TLM6td5lqDWuvP5Ejd8oUmYVZ&$q=firework&$where=created_date between '2015-07-01T00:00:00' and '2015-07-06T00:00:00'", function(data) {
		...
		thismap.FIREWORKS = L.geoJson(geojsonData, {
		    pointToLayer: DNAinfoNYCFireworks2015citywide.getStyleFor_FIREWORKS,
			onEachFeature: DNAinfoNYCFireworks2015citywide.onEachFeature_FIREWORKS
		});
...
DNAinfoNYCFireworks2015citywide.prototype.loadNeighborhoods = function (){
	var thismap = this;
	...
	function drawPolys() {
		thismap.POLYGONS = L.geoJson(polyTopojson, {
		    style: DNAinfoNYCFireworks2015citywide.getStyleFor_POLYGONS,
			onEachFeature: DNAinfoNYCFireworks2015citywide.onEachFeature_POLYGONS
		});
...
DNAinfoNYCFireworks2015citywide.getStyleFor_FIREWORKS = function (feature, latlng){
...
DNAinfoNYCFireworks2015citywide.getStyleFor_POLYGONS = function (feature){
    return {
        weight: 2,
        opacity: 1,
        color: '#bdbdbd',
...
DNAinfoNYCFireworks2015citywide.checkZoomSwitchLayers = function (){
...
DNAinfoNYCFireworks2015citywide.centerBySubdomain = function (){
