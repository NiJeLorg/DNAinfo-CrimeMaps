...
// initialize map
function DNAinfoNYCFireworks2010to2014torque() {
	// set zoom and center for this map
	this.center = DNAinfoNYCFireworks2010to2014torque.centerBySubdomain();
    this.zoom = 14;
	...
	this.map.on('zoomend', function(e) {
	    DNAinfoNYCFireworks2010to2014torque.checkZoomSwitchLayers();
	});
...
DNAinfoNYCFireworks2010to2014torque.slightPanUp = function (){
	var point = L.point(0, 150);
	MY_MAP.map.panBy(point);
}

DNAinfoNYCFireworks2010to2014torque.onEachFeature_FIREWORKS = function(feature,layer){	
	var highlight = {
	    weight: 2,
	    color: '#000'
	};
...
DNAinfoNYCFireworks2010to2014torque.onEachFeature_POLYGONS = function(feature,layer){	
	var highlight = {
	    color: '#000'
	};
	var noHighlight = {
...
DNAinfoNYCFireworks2010to2014torque.prototype.loadPointLayers = function (){
	// load points layers
	var thismap = this;
	var dateFormat = d3.time.format("%Y-%m-%dT%X.%L");
	var heatMapData = [];
	d3.json("https://data.cityofnewyork.us/resource/fhrw-4uyv.geojson?$$app_token=k9QzGy6blIYoYXiF7AgFMxgHV&$q=firework&$where=created_date between '2014-07-01T00:00:00' and '2014-07-06T00:00:00' or created_date between '2013-07-01T00:00:00' and '2013-07-06T00:00:00' or created_date between '2012-07-01T00:00:00' and '2012-07-06T00:00:00' or created_date between '2011-07-01T00:00:00' and '2011-07-06T00:00:00' or created_date between '2010-07-01T00:00:00' and '2010-07-06T00:00:00'", function(data) {
		geojsonData = data;
		...
		thismap.FIREWORKS = L.geoJson(geojsonData, {
		    pointToLayer: DNAinfoNYCFireworks2010to2014torque.getStyleFor_FIREWORKS,
			onEachFeature: DNAinfoNYCFireworks2010to2014torque.onEachFeature_FIREWORKS
		}).addTo(thismap.map);
		...
		var CARTOCSS = [
		  'Map {',
		  '-torque-time-attribute: "created_date";',
		...
		thismap.TORQUEMAP = new L.TorqueLayer({
			user       : 'jd',
			table      : 'fhrw_4uyv_1',
			cartocss: CARTOCSS
		});
		thismap.TORQUEMAP.error(function(err){
			for(error in err){
				console.warn(err[error]);
			}
		});
		thismap.TORQUEMAP.addTo(thismap.map);
...
DNAinfoNYCFireworks2010to2014torque.prototype.loadNeighborhoods = function (){
	var thismap = this;
	...
	function drawPolys() {
		thismap.POLYGONS = L.geoJson(polyTopojson, {
		    style: DNAinfoNYCFireworks2010to2014torque.getStyleFor_POLYGONS,
			onEachFeature: DNAinfoNYCFireworks2010to2014torque.onEachFeature_POLYGONS
		});
...
DNAinfoNYCFireworks2010to2014torque.getStyleFor_FIREWORKS = function (feature, latlng){
...
DNAinfoNYCFireworks2010to2014torque.getStyleFor_POLYGONS = function (feature){
    return {
        weight: 2,
        opacity: 1,
        color: '#bdbdbd',
...
DNAinfoNYCFireworks2010to2014torque.checkZoomSwitchLayers = function (){
	...
	if (MY_MAP.map.getZoom() < 14) {
		...
		MY_MAP.TORQUEMAP.play();
	} else {
		MY_MAP.TORQUEMAP.stop();
		MY_MAP.FIREWORKS.addTo(MY_MAP.map);
		MY_MAP.POLYGONS.addTo(MY_MAP.map);
	}		
...
DNAinfoNYCFireworks2010to2014torque.centerBySubdomain = function (){
