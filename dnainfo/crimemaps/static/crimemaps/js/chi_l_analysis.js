...
$(document).ready(function () {
    ...
    function createFBandTwitterURLs() {
        ...
        $.ajax({
            type: "GET",
            url: "/chi-l/createCHITrainBitlyLink/?train=" + encodeURIComponent(color + "-line"),
            success: function(bitlyURL){
                ...
                var via = 'DNAinfoCHI';
                var twittercaption = "The most popular places to sit, stand and ride on the "+ lineSelected +" (according to you)";
