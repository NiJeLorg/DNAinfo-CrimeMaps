...
ajaxApplication.firstMove = function () {
	...
	function slow() {
		$.ajax({
			type: "GET",
			url: "/new-york/visualizations/apartment-test-for-danny-nyc/firstMove/",
...
ajaxApplication.nextLocation = function () {
	...
	function slow() {
		...
		f.on('submit', function(e) {
			...
			$.ajax({
				type: "POST",
				url: "/new-york/visualizations/apartment-test-for-danny-nyc/whatNeighborhood/"+ objectID +"/",
				data: f.serialize(),
				success: function(data){
					$('#content').html(data);
					$(".fadein").fadeIn("slow");
...
ajaxApplication.nextYearMoved = function () {
	...
	function slow() {
		...
		f.on('submit', function(e) {
			...
			$.ajax({
				type: "POST",
				url: "/new-york/visualizations/apartment-test-for-danny-nyc/exactLocation/"+ objectID +"/",
				data: f.serialize(),
				success: function(data){
					$('#content').html(data);
					// remove label
...
ajaxApplication.nextBedrooms = function (checked) {
	...
	function slow() {
		...
		f.on('submit', function(e) {
			...
			$.ajax({
				type: "POST",
				url: "/new-york/visualizations/apartment-test-for-danny-nyc/yearMoved/"+ objectID +"/",
				data: f.serialize(),
				success: function(data){
					$('#content').html(data);
					// remove labels
...
ajaxApplication.nextRentSplit = function () {
	...
	function slow() {
		...
		f.on('submit', function(e) {
			...
			$.ajax({
				type: "POST",
				url: "/new-york/visualizations/apartment-test-for-danny-nyc/bedrooms/"+ objectID +"/",
				data: f.serialize(),
				success: function(data){
					$('#content').html(data);
					// remove labels
...
ajaxApplication.nextiPaid = function () {
	...
	function slow() {
		...
		f.on('submit', function(e) {
			...
			$.ajax({
				type: "POST",
				url: "/new-york/visualizations/apartment-test-for-danny-nyc/rentSplit/"+ objectID +"/",
				data: f.serialize(),
				success: function(data){
					$('#content').html(data);
					//remove labels
...
ajaxApplication.nextAllPaid = function () {
	...
	function slow() {
		...
		f.on('submit', function(e) {
			...
			$.ajax({
				type: "POST",
				url: "/new-york/visualizations/apartment-test-for-danny-nyc/iPaid/"+ objectID +"/",
				data: f.serialize(),
				success: function(data){
					$('#content').html(data);
					//remove labels
...
ajaxApplication.nextCalc = function () {
	...
	function slow() {
		...
		f.on('submit', function(e) {
			...
			$.ajax({
				type: "POST",
				url: "/new-york/visualizations/apartment-test-for-danny-nyc/allPaid/"+ objectID +"/",
				data: f.serialize(),
				success: function(data){
					$('#content').html(data);
					$(".fadein").fadeIn("slow");
...
ajaxApplication.nextResults = function (id) {
	...
	function slow() {
		$.ajax({
			type: "GET",
			url: "/new-york/visualizations/apartment-test-for-danny-nyc/end/"+id+"/",
			success: function(data){
				$('#content').html(data);
				$(".fadein").fadeIn("slow");
				// scroll to top
...
ajaxApplication.backIntro = function () {
	...
	function slow() {
		$.ajax({
			type: "GET",
			url: "/new-york/visualizations/apartment-test-for-danny-nyc/",
			success: function(data){
				$('#content').html(data);
				$(".fadein").fadeIn("slow");
				// scroll to top
...
ajaxApplication.backFirstMove = function (id) {
	...
	function slow() {
		$.ajax({
			type: "GET",
			url: "/new-york/visualizations/apartment-test-for-danny-nyc/firstMove/"+id+"/",
			success: function(data){
				$('#content').html(data);
				// remove labels
				$('label').remove();
...
ajaxApplication.backNeighborhood = function (id) {
	...
	function slow() {
		$.ajax({
			type: "GET",
			url: "/new-york/visualizations/apartment-test-for-danny-nyc/whatNeighborhood/"+id+"/",
			success: function(data){
		 		$('#content').html(data);
				// remove labels
				$('label').remove();
...
ajaxApplication.backLocation = function (id) {
	...
	function slow() {
		$.ajax({
			type: "GET",
			url: "/new-york/visualizations/apartment-test-for-danny-nyc/exactLocation/"+id+"/",
			success: function(data){
				$('#content').html(data);
				$(".fadein").fadeIn("slow");
				// scroll to top
...
ajaxApplication.backYearMoved = function (id) {
	...
	function slow() {
		$.ajax({
			type: "GET",
			url: "/new-york/visualizations/apartment-test-for-danny-nyc/yearMoved/"+id+"/",
			success: function(data){
				$('#content').html(data);
				// remove label
				$("label[for='id_exactYearMoved']").remove();
...
ajaxApplication.backBedrooms = function (id) {
	...
	function slow() {
		$.ajax({
			type: "GET",
			url: "/new-york/visualizations/apartment-test-for-danny-nyc/bedrooms/"+id+"/",
			success: function(data){
				$('#content').html(data);
				// remove labels
				$('label').remove();
...
ajaxApplication.backRentSplit = function (id) {
	...
	function slow() {
		$.ajax({
			type: "GET",
			url: "/new-york/visualizations/apartment-test-for-danny-nyc/rentSplit/"+id+"/",
			success: function(data){
				$('#content').html(data);
				// remove labels
				$('label').remove();
...
ajaxApplication.backiPaid = function (id) {
	...
	function slow() {
		$.ajax({
			type: "GET",
			url: "/new-york/visualizations/apartment-test-for-danny-nyc/iPaid/"+id+"/",
			success: function(data){
				$('#content').html(data);
				//remove labels
				$('label').remove();
