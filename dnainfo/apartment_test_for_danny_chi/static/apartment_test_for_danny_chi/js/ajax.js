...
ajaxApplication.firstMove = function () {
	...
	function slow() {
		$.ajax({
			type: "GET",
			url: "/chicago/visualizations/apartment-test-for-danny-chi/firstMove/",
...
ajaxApplication.nextLocation = function () {
	...
	function slow() {
		...
		f.on('submit', function(e) {
			...
			$.ajax({
				type: "POST",
				url: "/chicago/visualizations/apartment-test-for-danny-chi/whatNeighborhood/"+ objectID +"/",
				data: f.serialize(),
				success: function(data){
					$('#content').html(data);
					$(".fadein").fadeIn("slow");
...
ajaxApplication.nextYearMoved = function () {
	...
	function slow() {
		...
		f.on('submit', function(e) {
			...
			$.ajax({
				type: "POST",
				url: "/chicago/visualizations/apartment-test-for-danny-chi/exactLocation/"+ objectID +"/",
				data: f.serialize(),
				success: function(data){
					$('#content').html(data);
					// remove label
...
ajaxApplication.nextBedrooms = function (checked) {
	...
	function slow() {
		...
		f.on('submit', function(e) {
			...
			$.ajax({
				type: "POST",
				url: "/chicago/visualizations/apartment-test-for-danny-chi/yearMoved/"+ objectID +"/",
				data: f.serialize(),
				success: function(data){
					$('#content').html(data);
					// remove labels
...
ajaxApplication.nextRentSplit = function () {
	...
	function slow() {
		...
		f.on('submit', function(e) {
			...
			$.ajax({
				type: "POST",
				url: "/chicago/visualizations/apartment-test-for-danny-chi/bedrooms/"+ objectID +"/",
				data: f.serialize(),
				success: function(data){
					$('#content').html(data);
					// remove labels
...
ajaxApplication.nextiPaid = function () {
	...
	function slow() {
		...
		f.on('submit', function(e) {
			...
			$.ajax({
				type: "POST",
				url: "/chicago/visualizations/apartment-test-for-danny-chi/rentSplit/"+ objectID +"/",
				data: f.serialize(),
				success: function(data){
					$('#content').html(data);
					//remove labels
...
ajaxApplication.nextAllPaid = function () {
	...
	function slow() {
		...
		f.on('submit', function(e) {
			...
			$.ajax({
				type: "POST",
				url: "/chicago/visualizations/apartment-test-for-danny-chi/iPaid/"+ objectID +"/",
				data: f.serialize(),
				success: function(data){
					$('#content').html(data);
					//remove labels
...
ajaxApplication.nextCalc = function () {
	...
	function slow() {
		...
		f.on('submit', function(e) {
			...
			$.ajax({
				type: "POST",
				url: "/chicago/visualizations/apartment-test-for-danny-chi/allPaid/"+ objectID +"/",
				data: f.serialize(),
				success: function(data){
					$('#content').html(data);
					$(".fadein").fadeIn("slow");
...
ajaxApplication.nextResults = function (id) {
	...
	function slow() {
		$.ajax({
			type: "GET",
			url: "/chicago/visualizations/apartment-test-for-danny-chi/end/"+id+"/",
			success: function(data){
				$('#content').html(data);
				$(".fadein").fadeIn("slow");
				// scroll to top
...
ajaxApplication.backIntro = function () {
	...
	function slow() {
		$.ajax({
			type: "GET",
			url: "/chicago/visualizations/apartment-test-for-danny-chi/",
			success: function(data){
				$('#content').html(data);
				$(".fadein").fadeIn("slow");
				// scroll to top
...
ajaxApplication.backFirstMove = function (id) {
	...
	function slow() {
		$.ajax({
			type: "GET",
			url: "/chicago/visualizations/apartment-test-for-danny-chi/firstMove/"+id+"/",
			success: function(data){
				$('#content').html(data);
				// remove labels
				$('label').remove();
...
ajaxApplication.backNeighborhood = function (id) {
	...
	function slow() {
		$.ajax({
			type: "GET",
			url: "/chicago/visualizations/apartment-test-for-danny-chi/whatNeighborhood/"+id+"/",
			success: function(data){
		 		$('#content').html(data);
				// remove labels
				$('label').remove();
...
ajaxApplication.backLocation = function (id) {
	...
	function slow() {
		$.ajax({
			type: "GET",
			url: "/chicago/visualizations/apartment-test-for-danny-chi/exactLocation/"+id+"/",
			success: function(data){
				$('#content').html(data);
				$(".fadein").fadeIn("slow");
				// scroll to top
...
ajaxApplication.backYearMoved = function (id) {
	...
	function slow() {
		$.ajax({
			type: "GET",
			url: "/chicago/visualizations/apartment-test-for-danny-chi/yearMoved/"+id+"/",
			success: function(data){
				$('#content').html(data);
				// remove label
				$("label[for='id_exactYearMoved']").remove();
...
ajaxApplication.backBedrooms = function (id) {
	...
	function slow() {
		$.ajax({
			type: "GET",
			url: "/chicago/visualizations/apartment-test-for-danny-chi/bedrooms/"+id+"/",
			success: function(data){
				$('#content').html(data);
				// remove labels
				$('label').remove();
...
ajaxApplication.backRentSplit = function (id) {
	...
	function slow() {
		$.ajax({
			type: "GET",
			url: "/chicago/visualizations/apartment-test-for-danny-chi/rentSplit/"+id+"/",
			success: function(data){
				$('#content').html(data);
				// remove labels
				$('label').remove();
...
ajaxApplication.backiPaid = function (id) {
	...
	function slow() {
		$.ajax({
			type: "GET",
			url: "/chicago/visualizations/apartment-test-for-danny-chi/iPaid/"+id+"/",
			success: function(data){
				$('#content').html(data);
				//remove labels
				$('label').remove();
