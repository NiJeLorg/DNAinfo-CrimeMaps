...
osmApplication.updateSocialLinks = function (lat, lon, zoom, tilt, rotation, buildingShared) {
    ...
    osmApplication.sharelink = 'https://hzdl3dry-data-viz-future-map.build.qa.dnainfo.com/chicago/visualizations/skyline?browse&hood='+hoodID+'?lat='+lat+'&lon='+lon+'&zoom='+zoom+'&tilt='+tilt+'&rotation='+rotation+'&building='+buildingShared;
