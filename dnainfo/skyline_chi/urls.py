...
urlpatterns = [
    ...
    url(r'^skyline/admin/chi/sponsored/buildingHeightEdit/(?P<id>\d+)/$', views.skyline_chi_sponsoredBuildingHeightEdit, name='skyline_chi_sponsoredBuildingHeightEdit'),
    ...
    url(r'^skyline/admin/chi/reporter/buildingHeightEdit/(?P<id>\d+)/$', views.skyline_chi_reporterBuildingHeightEdit, name='skyline_chi_reporterBuildingHeightEdit'),
